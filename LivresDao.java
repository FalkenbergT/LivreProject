...
public class LivresDao {
    ...
    //initialisation de l'ensemble des variable
    ...
    private SQLiteDatabase bdd; // création d'une base de donnée
    private MaBaseSQLite maBaseSQLite;  //création d'une autres bdd

    public LivresDao(Context context) {
    ...
    public SQLiteDatabase getBDD() { //permet d'obtenir la BDD
        return bdd;
    }
    ...
    public int removeLivreWithTitre(String titre) {
        //Suppression d'un livre de la BDD grâce à l'ID
        return bdd.delete(TABLE_LIVRES, COL_TITRE+ " = \"" + titre+"\"", null);
    ...
    public String LivreWithTitre(String titre)
    {
        String test="";
        Cursor cursor = bdd.query(TABLE_LIVRES, new String[]{COL_ID, COL_ISBN, COL_TITRE}, "", null, null, null, null);
      while(cursor.moveToNext())
      {
          if(cursor.getString(NUM_COL_TITRE).equals(titre))
          {
              test="présent";
          }
          else
    ...
    public List<Livre> getAlllivres(){
        ...
        while(cursor.moveToNext()) {
            ...
            String titre = cursor.getString(NUM_COL_TITRE);
